            ...
            <div className="flex w-full items-center px-2 border border-slate-600 rounded-xl">
                ...
                <div className="relative w-1/2">
                    ...
                    <div className="absolute inset-y-0 right-0 max-sm:pr-1 md:pr-3 flex items-center text-gray-400 cursor-pointer">
                        <button className="h-6 w-6 md:max-lg:mx-3 sm:mx-1" onClick={copyToClipboard}><Copy/></button>
                        {showPassword ? (
                            <button className="h-6 w-6" onClick={togglePasswordVisibility}><EyeOff/></button>
                        ) : (
                            <button className="h-6 w-6" onClick={togglePasswordVisibility}><Eye/></button>
                        )}
                    </div>
