...
export default function Login({ searchParams, }: { searchParams: { message: string, from?: string } }) {
  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
      ...
      <Link href={'/auth/forgot'} className="btn btn-ghost">Forgot ur password?</Link>
    </div>
  )
}
